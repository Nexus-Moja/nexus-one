(function(){
  ...
  function injectManageTrip(){
    ...
    async function showManageActions(booking,ref,phone){
      ...
      actions.innerHTML=`
        <div style="position:relative;left:calc(-50vw + 50%);width:100vw;background:#fff;border:1px solid #dce6ee;border-radius:10px;overflow:hidden;font-size:12px;box-sizing:border-box">
          <!-- Title bar -->
