(function(){
  ...
  function injectManageTrip(){
    ...
    content.innerHTML=`
      ...
      <div class="nexusManageActions" style="display:none;margin-top:12px;margin-left:-16px;margin-right:-16px;width:calc(100% + 32px);padding:16px;box-sizing:border-box"></div>`;
