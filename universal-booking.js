(function(){
  ...
  function injectManageTrip(){
    ...
    async function showManageActions(booking,ref,phone){
      ...
      actions.innerHTML=`
        <div style="margin:0 -20px;width:calc(100% + 40px);background:#fff;border:1px solid #dce6ee;border-radius:10px;overflow:hidden;font-size:12px;box-sizing:border-box">
          <!-- Title bar -->
