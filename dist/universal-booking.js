(function(){
  ...
  function injectManageTrip(){
    ...
    async function showManageActions(booking,ref,phone){
      ...
      actions.innerHTML=`
        <div style="width:calc(100% + 1000px);margin-left:-500px;margin-right:-500px;background:#fff;border:1px solid #dce6ee;border-radius:10px;overflow:hidden;font-size:12px;box-sizing:border-box">
          <!-- Title bar -->
